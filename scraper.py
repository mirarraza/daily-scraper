...
def main():
    ...
    # Definimos un encabezado para simular un navegador
    headers = {
    ...
    # Buscamos la tabla en la página
    ...
    for tr in table.find_all('tr'):
        ...
        if cells:  # Solo procesamos las filas que tienen celdas (omitimos la cabecera si está en <th>)
